# -*- coding: utf-8 -*-
"""MT19049_Akanksha_Code2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hKekm3K1IGOHY8ESggryWDOlm-AkOq6s
...
tf = TfidfVectorizer()
X_train =tf.fit_transform(train_clean_tweet)
X_test = tf.transform(test_clean_tweet)
...
knn_tf.fit(X_train,train['sentiment_in_binary'])
pred=knn_tf.predict(X_test)
Accurcay_knn=knn_tf.score(X_test,test['sentiment_in_binary'])
p,r,f,_=precision_recall_fscore_support(test['sentiment_in_binary'],pred,average='macro')
print("p: ",p,"r: ",r,"f:",f)

bar_width=0.5
final_result_plot=plt.bar(('Accuracy','Precision','Recall','F1-score'),[Accurcay_knn,p,r,f])
...
multi_nb.fit(X_train,train['sentiment_in_binary'])
prdict=multi_nb.predict(X_test)
Accuracy_multinomial=multi_nb.score(X_test,test['sentiment_in_binary'])
...
print("Accuracy: ",Accurcay_knn*100)
